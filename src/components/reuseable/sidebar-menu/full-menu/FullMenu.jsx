...
const FullMenu = ({ closeFullMenu, logoutHandler }) => {
    ...
    const [doctorateAlumniDropdown, setDoctorateAlumniDropdown] =
        useState(false);
         ...
         flex flex-col overflow-auto no-scrollbar shadow-xl"
            ...
            >
               ...
               hover:bg-gray-300  rounded px-4 py-3 transition-all ${
                   pathname === "/admin-panel" && "bg-gray-200 font-bold"
               }`}
                        >
                ...
                <ul className="space-y-3" id="admin_section">
                    ...
                    >
                        <p
                            className={`text-gray-700 hover:text-black text-sm flex justify-between
             ${pathname === "/admin-panel/register" && "bg-gray-200 font-bold"}
             ${
                 pathname === "/admin-panel/password-change" &&
                 "bg-gray-200 font-bold"
             }
             ${
                 pathname === "/admin-panel/manage-admin-accounts" &&
                 "bg-gray-200 font-bold"
             }
             items-center hover:bg-gray-300  rounded px-4 py-3 transition-all`}
                        >
                ...
                ${
                    ...
                    <li
                        onClick={closeFullMenu}
                        className={superAdmin ? "visible" : "hidden"}
                    >
                        <Link
                ...
                <ul className="space-y-3" id="alumni_section">
                    ...
                    >
                        <p
                            className={`
                 ${
                     pathname === "/admin-panel/manage-masters-alumni" &&
                     "bg-gray-200 font-bold"
                 }
              ${
                  pathname === "/admin-panel/upload-masters-alumni" &&
                  "bg-gray-200 font-bold"
              }
              text-gray-700 hover:text-black text-sm flex justify-between items-center hover:bg-gray-300  rounded px-4 py-3 transition-all
                `}
                        >
                ...
                ${
                    ...
                    >
                        <p
                            ...
                            ${
                                pathname ===
                                    "/admin-panel/manage-doctorate-alumni" &&
                                "bg-gray-200 font-bold"
                            }
                         ${
                             pathname ===
                                 "/admin-panel/upload-doctorate-alumni" &&
                             "bg-gray-200 font-bold"
                         }
                         text-gray-700 hover:text-black text-sm flex justify-between items-center hover:bg-gray-300  rounded px-4 py-3 transition-all
                           `}
                ...
                px-4 py-3 border-b-[1px] border-gray-400
                 ${
                     pathname === "/admin-panel/manage-doctorate-alumni"
                         ? "text-blue-800 font-bold"
                         : "text-gray-700"
                 }`}
                            >
                ...
                flex justify-center items-center hover:bg-gray-300  hover:font-bold 
                px-4 py-3 transition-all   ${
                    pathname === "/admin-panel/upload-doctorate-alumni"
                        ? "text-blue-800 font-bold"
                        : "text-gray-700"
                }`}
                            >
                ...
                <ul className="space-y-3" id="member_section">
                    ...
                    >
                        <p
                            className={`
            text-gray-700 hover:text-black text-sm flex justify-between 
            items-center hover:bg-gray-300  rounded px-4 py-3 transition-all
                ${
                    pathname === "/admin-panel/manage-msc-members" &&
                    "bg-gray-200 font-bold"
                }
              ${
                  pathname === "/admin-panel/upload-msc-member" &&
                  "bg-gray-200 font-bold"
              }
            ...
            items-center hover:bg-gray-300  rounded px-4 py-3 transition-all
                ${
                    pathname === "/admin-panel/manage-phd-members" &&
                    "bg-gray-200 font-bold"
                }
              ${
                  pathname === "/admin-panel/upload-phd-member" &&
                  "bg-gray-200 font-bold"
              }
            ...
            items-center hover:bg-gray-300  rounded px-4 py-3 transition-all
              ${
                  pathname === "/admin-panel/manage-personal-awards" &&
                  "bg-gray-200 font-bold"
              }
              ${
                  pathname === "/admin-panel/upload-personal-award" &&
                  "bg-gray-200 font-bold"
              }
            ...
            items-center hover:bg-gray-300  rounded px-4 py-3 transition-all
              ${
                  pathname === "/admin-panel/manage-team-awards" &&
                  "bg-gray-200 font-bold"
              }
              ${
                  pathname === "/admin-panel/upload-team-award" &&
                  "bg-gray-200 font-bold"
              }
            ...
            `}
              ...
              items-center hover:bg-gray-300  rounded px-4 py-3 transition-all
                ${
                    pathname === "/admin-panel/manage-lab-instruments" &&
                    "bg-gray-200 font-bold"
                }
                ${
                    pathname === "/admin-panel/upload-lab-instrument" &&
                    "bg-gray-200 font-bold"
                }
              ...
              items-center hover:bg-gray-300  rounded px-4 py-3 transition-all
                ${
                    pathname === "/admin-panel/manage-group-news" &&
                    "bg-gray-200 font-bold"
                }
                ${
                    pathname === "/admin-panel/upload-group-news" &&
                    "bg-gray-200 font-bold"
                }
              ...
              `}
               ...
               hover:bg-gray-300  rounded px-4 py-3 transition-all
               ${
                   pathname === "/admin-panel/manage-contacts" &&
                   "bg-gray-200 font-bold"
               }`}
                        >
                            <MdDashboard className="text-xl text-gray-700" />
              ...
              items-center hover:bg-gray-300  rounded px-4 py-3 transition-all
                ${
                    pathname === "/admin-panel/manage-projects" &&
                    "bg-gray-200 font-bold"
                }
                ${
                    pathname === "/admin-panel/upload-project" &&
                    "bg-gray-200 font-bold"
                }
              ...
              items-center hover:bg-gray-300  rounded px-4 py-3 transition-all
                ${
                    pathname === "/admin-panel/manage-publications" &&
                    "bg-gray-200 font-bold"
                }
                ${
                    pathname === "/admin-panel/upload-publication" &&
                    "bg-gray-200 font-bold"
                }
